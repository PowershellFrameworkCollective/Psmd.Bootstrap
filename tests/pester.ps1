...
Remove-Module Psmd.Bootstrap -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\Psmd.Bootstrap\Psmd.Bootstrap.psd1"
Import-Module "$PSScriptRoot\..\Psmd.Bootstrap\Psmd.Bootstrap.psm1" -Force
