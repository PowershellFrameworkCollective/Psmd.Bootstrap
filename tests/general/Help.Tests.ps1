...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\Psmd.Bootstrap\functions", "$global:testroot\..\Psmd.Bootstrap\internal\functions"),
	
	[string]
	$ModuleName = "Psmd.Bootstrap",
...
$CommandPath = @(
    "$global:testroot\..\Psmd.Bootstrap\functions"
    "$global:testroot\..\Psmd.Bootstrap\internal\functions"
)
